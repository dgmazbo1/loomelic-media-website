...
## Nav & Structure Restructure (User Request Mar 10)
- [x] Revert hero headline back to original (remove "Content Systems Built for Dealerships")
- [x] Remove Solutions from navbar entirely
- [x] Move all 7 solution verticals into Services as Dealer Services (same premium layout)
- [x] Keep Premium Web Services and Event Coverage as standalone services under Services
- [x] Merge/remove old duplicate service pages
- [x] Rename Case Studies → Portfolio throughout (nav, routes, pages, links)
- [x] Update /case-studies route to /portfolio
- [x] Update all internal links from /case-studies to /portfolio
- [x] Update Navbar Services mega-menu to reflect new structure
- [x] Clean up App.tsx routes
