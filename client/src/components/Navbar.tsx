...
const SERVICE_ITEMS = [
  ...
  { label: "Inventory Photography", href: "/services/dealer-services/inventory-photography", sub: true },
  { label: "Short-Form Reels", href: "/services/dealer-services/short-form-reels", sub: true },
  { label: "Walkaround Videos", href: "/services/dealer-services/walkaround-videos", sub: true },
